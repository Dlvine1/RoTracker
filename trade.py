...
ignore = ['1', '15189', '80254', '986', '451687511']
itemData = None
    ...
    async def sendTrade(self, player1, player2, p1_offer, p2_offer):
        ...
        if p1_value >= 5000 and p2_value >= 5000:
            ...
            if itemData[highest][4] >= 1000000:
                webhook = DiscordWebhook(url='https://discord.com/api/webhooks/1190507496025100319/LVxaL2XD2KWu9fDAuCutLTzkiDBFT1MRDtfrlKsCd9-lU0iBUuXKe_VrCxOJRciPFh-r')
            elif itemData[highest][4] >= 100000:
                webhook = DiscordWebhook(url='https://discord.com/api/webhooks/1190507331700674560/Yp7ugk7Awr-XO4SfKyKdwbe-oAc31jwG_BCrYp3DMXKUdLSdKLBJ_HMXMx2GWuCJZRrP')
            else:
                webhook = DiscordWebhook(url='https://discord.com/api/webhooks/1190493526245523487/dGW3RW6eyAPIx1XKwQ69VHLjrhi07xr-X8wBpP2NSboqisC6A0MEXSsUEUHwrd0KrcYR')
